...
# def save_one_person(person_id: str, data_dir: pathlib.Path, image_dir: pathlib.Path,
...
#     person = str(data_dir) + "/" + str(person_id) + "a.npy"
#     # person_dir = data_dir / person_id + "a.npy"

#     print("DIr" , person)
#     npfile = np.load(person, allow_pickle=True)
#     print(np.shape(npfile))
#     return
#     for path in sorted(person_dir.glob('*')):
#         mat_data = scipy.io.loadmat(path.as_posix(),
#                                     struct_as_record=False,
...
#     parser.add_argument('--dataset', type=str, required=True)
#     parser.add_argument('--output-dir', '-o', type=str, required=True)
#     parser.add_argument('--image', '-idata', type=str, required=True)
#     args = parser.parse_args()
...
#     image_dir = pathlib.Path(args.image)
#     print(dataset_dir)
#     print(output_dir)
#     print(image_dir)
#     for person_id in tqdm.tqdm(range(15)):
...
#         save_one_person(person_id, data_dir, image_dir, output_path)
